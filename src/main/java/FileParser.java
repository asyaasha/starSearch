 ...
 *
 * File Parser class that goes through the requested file and parses all pertinent information to pass to the Simulation
 */
...
class FileParser {
        ...
        try {
	        ...
	        */
            ...
            if (Integer.parseInt(data.get(nextValidLine)) > 0) {
                ...
                //Obstacle Instruction Container
    ...
    /**
     * Returns instruction set generated by FileParser
     * @return
     */
